---
title: "Release Notes of twinstudio"
---
...
- **[Catalog]:**
    ...
    - Introduced [Catalog of Files](/studio-catalog#catalog-of-files):
        - List all files stored in [twinsphere's File Repository](/cloud-documentation#file-repository).
