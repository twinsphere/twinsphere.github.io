...
In order to obtain a new discovery instance please contact our [support team](/contact).
...
:::caution[Deprecation of GET /lookup/shells]
...
In order to obtain such a new registry instance please contact our [support team](/contact).
...
:::note[Please notice]
There is currently no way to search for a tfp in the file repository, as no metadata about the file
