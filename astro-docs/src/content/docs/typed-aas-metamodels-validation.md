---
title: "Validation in twinsphere.TypedAasMetamodels"
---
...
For the [submodels supported by the DevKit](/typed-aas-metamodels-submodels), the validator additionally applies
...
- **Textual constraints**: Many submodel template specifications describe additional constraints in natural language
    ...
    [submodels it supports](/typed-aas-metamodels-submodels), but for others you can add your own via the
