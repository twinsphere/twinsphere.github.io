...
[RBAC roles](/management-roles) apply across the entire twinsphere platform.
:::
...
- A [group](/management-overview) (e.g., `group@factory-admins`)
...
[file attributes](/cloud-documentation#usage-of-file-api) instead of extensions.
:::
...
Files in the [file repository](/cloud-documentation#file-repository) can also be protected by
security attributes. Unlike Shells and Submodels, file security attributes are defined via
[file attributes](/cloud-documentation#usage-of-file-api) rather than extensions.
