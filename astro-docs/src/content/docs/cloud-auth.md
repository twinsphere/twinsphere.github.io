...
- using [twinsphere ID](/id-overview), which is the default built-in authentication provider. Both user and service
account authentication modes are supported, consult the [twinsphere ID documentation](/id-overview) for more information.
...
Please provide the noted information to the twinsphere [support team](/contact) to change and update your tenant
configuration:
...
4. Add the following redirect URL:
    ...
    - If you don't know which URL to add here, please ask our [support team](/contact)
