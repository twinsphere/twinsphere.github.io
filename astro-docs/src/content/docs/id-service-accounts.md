...
Service accounts can be created via the [Management API](/management-api).

## Usage

:::note
The example below shows a service account created via the [Management API](/management-api).
The same data is also available in the [Manage UI](/management-overview).
:::
...
Once you create your service account through [Management API](/management-api), you will get a list of
...
> Consult the [Management API](/management-api) documentation on how to create secrets which are also required
