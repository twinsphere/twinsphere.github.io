...
In addition to the IDTA AAS API Specification, twinsphere offers supplementary proprietary features:

- [Import of AASX packages](cloud-documentation.md#import)
- [Enhanced GET /shells](cloud-documentation.md#enhanced-get-shells)
